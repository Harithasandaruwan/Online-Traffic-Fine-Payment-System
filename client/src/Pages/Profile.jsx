  ...
  return (
    <div className="container mt-5">
      <div className="card shadow-lg p-4">
        ...
        <div className="mt-5">
          <Link className="btn btn-success w-50 mb-2" to="/additem">
            Add Payment
          </Link>
     
        
          <Link className="btn btn-info w-50" to="/items">
            My Payment Details
          </Link>
          <Link className="btn btn-info w-50" to="/DiliveryProfile">
            My Deliver Details
          </Link>
      
          <Link className="btn btn-info w-50" to="/dilivery">
          Delivery
          </Link>
   <br></br>
   <br></br>
          <Link className="btn btn-info w-50" to="/fine">
          Add Fine
          </Link>
