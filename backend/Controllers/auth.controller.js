...
import Item from "../models/Payment.model.js";
...
export const store=async(req,res,next)=>{
    const {userId,fname,payment_id,finePaymentid,payment_method,crd_number,expd_date,cvv,amount
    ...
    const newItem=new Item({petId,userId,fname,payment_id,finePaymentid,payment_method,crd_number,expd_date,cvv,amount});
    try{
        await newItem.save();
